...
cat("                             분류 = paste(광역자치, 기초자치, sep = '_' ),  ", '\n')
cat("                             gm.conv = conv-mean(conv, na.rm=T))  ", '\n')
cat("  ", '\n')
cat("  df %>% \033[1;36mmutate\033[0m(Gender_Label = \033[1;36mrecode\033[0m(gender, 'old값1' = 'new값1', 'old값2' = 'new값2')) ", '\n')
cat("  ", '\n')
...
cat("\033[1;34m**************************************************************** \033[0m ", '\n')
cat("\033[1;33m## tidyr사용법 I -------  \033[0m ", '\n')
...
cat("   library(tidyr); library(dplyr)   ", '\n')
cat("   data1 <- data %>% mutate(분류 = paste(V1, V2, sep = '_' ) )  ", '\n')
cat("   data2 <- data1 %>% select(분류, V1, V3, V4) ", '\n')
cat("   ", '\n')
...
cat("  Adata$check<-\033[1;31mrowSums\033[0m(Adata[, c(3:4)], na.rm=T)   ", '\n')
cat("  Adata$check<-\033[1;31mrowMeans\033[0m(Adata[, c(3:4)], na.rm=T)   ", '\n')
cat("  ", '\n')
